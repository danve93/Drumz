...
export default class App extends Component {
  ...
  render() {
    return (
      <body>
        <div className="drum" style={{ background: "white" }} id="drum-machine">
          ...
          <div className="drum-control">
            ...
            <div className="drum-control-bank">
              <div>{this.state.bankIndex ? "Piano" : "Heater"}</div>
